  ...
  <div class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
    ...
    <div class="flex items-center space-x-4 mb-4">
      <div class="flex items-center">
        <input
          id="enable-polling-status"
          v-model="enablePolling"
          type="checkbox"
          class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700"
        />
        <label
          for="enable-polling-status"
      ...
      <div class="grid grid-cols-1 gap-4">
        <div>
          <span class="flex items-center">
            ...
            <span
              class="text-sm ml-1"
              :class="{ 'font-medium': motorStatus.enStatus !== 0 }"
            >
        ...
        <div>
          <span class="flex items-center">
            ...
            <span
              class="text-sm ml-1"
              :class="{ 'font-medium': motorStatus.protectionStatus !== 0 }"
            >
